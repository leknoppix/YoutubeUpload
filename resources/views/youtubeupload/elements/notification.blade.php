...
@if (session('status') === 'create-youtube-get-online-success')
    <div
        x-data="{ show: true }"
        x-show="show"
        x-transition:enter="transform ease-out duration-300 transition"
    ...
    >
        <div class="flex">
            ...
            <div>
                <p class="text-sm">{{ __('L\'ensemble des vidéos présents actuellement dans la chaîne Youtube a été ajoutée ou modifié avec succes.') }}</p>
            </div>
        </div>
    </div>
@endif
