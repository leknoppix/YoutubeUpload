...
class YoutubeUploadAccessTokenController
{
    ...
    {
        $channels = YoutubeUploadAccessToken::orderBy('updated_at', 'desc')->get();
    ...
    public function callback(Request $request): RedirectResponse
    {
        ...
        $channel = new YoutubeUploadAccessToken(
            [
    ...
    public function edit(YoutubeUploadAccessToken $channel): View
    {
        return view('youtubeupload.edit', ['channel' => $channel]);
    }

    public function update(Request $request, YoutubeUploadAccessToken $channel): RedirectResponse
    {
     ...
     */
    public function destroy(YoutubeUploadAccessToken $channel): RedirectResponse
    {
